                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="https://github.com/CasDoorn0570" target="_blank" class="dropdown-item">Gitub</a></li>
                                <li><a href="https://instagram.com/cas_doorn06" target="_blank" class="dropdown-item">Instagram</a></li>
                                <li><a href="https://tiktok.com/@cas.doorn" target="_blank" class="dropdown-item">Tiktok</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            <a href="/about" class="nav-link">Over Mij</a>
                        </li>
                        <li class="nav-item">
